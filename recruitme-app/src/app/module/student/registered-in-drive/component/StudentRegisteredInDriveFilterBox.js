...
const getStudentRegisteredInDrive = () => {
...
export const StudentRegisteredInDriveFilterBox = (props) => {
    const cssStyles = {
                ...
                <WrapperContainer boxShadow={false} id="card-0" style={{ width: "550px", marginTop: "-30px", marginBottom: "-20px" }} spacing={5} className={cssStyles.globalStyles.formContainer}>
                        ...
                        <FormGroup>
                            <FormControl>
                                <OutlinedSelectWrapper
                                    ...
                                    menulist={drives}
                                    onChange={(ev) => {
                                        studentRegisteredInDriveObj.setDriveId(ev.target.value);
                                    }}
                                    value={studentRegisteredInDriveObj.getDriveId()}
                                />
                            </FormControl>
                        </FormGroup>
                    </ContainerItem>
                    ...
                    <ContainerItem xs={12} sm={12} md={12} lg={12} xl={3}>
                        <Button
                            ...
                            style={{ float: "right" }}
                            onClick={() => {
                                props.searchStudentRegisteredInDrive(studentRegisteredInDriveObj)
                            }}
                        >Search</Button>
                    </ContainerItem>
                </WrapperContainer>
